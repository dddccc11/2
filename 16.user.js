// ==UserScript==
// @name автовход с бомбами и эликами экстры+победы
...
setInterval(function() {
    switch (gam_state) {
        ...
        case 'play':
            ...
            if (!bomb && mir.includes(myRole) && aliveMirCount > 3 && count > 50 && gam_data.v_time > 21) {
                _GM_action('', 'ext_act', '135', event);
                bomb = true;
            }
            if (!pol && mir.includes(myRole) && aliveMirCount == 1 && gam_data.v_mode) {
